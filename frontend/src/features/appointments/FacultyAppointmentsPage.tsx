    ...
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-8 p-6">
      <section className="space-y-2">
        ...
        <p className="max-w-2xl text-muted-foreground">
          Review student appointment requests and manage your
        ...
        <div className="space-y-10">
          {pendingAppointments.length > 0 && (
            <AppointmentSection
              ...
              description="Review appointment requests that are waiting for your response."
          ...
          {confirmedAppointments.length > 0 && (
            <AppointmentSection
              ...
              description="Manage your upcoming confirmed appointments."
          ...
          {otherAppointments.length > 0 && (
            <AppointmentSection
              ...
              description="Previously rejected, cancelled, or completed appointments."
...
type AppointmentSectionProps = {
  title: string
  description: string
  appointments: ReturnType<typeof useAppointmentsQuery>["data"]
